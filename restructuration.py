...
# Auteur : sofia
# Date : #date
# Jeu de dames : Plateau 10x10
# Auteur original : Sofian
# Restructuré par ChatGPT
# Date : 02.12.2024
...
def dessiner_echiquier():
    ...
    """
    ecran.fill(COULEURS["VERT"])  # Fond vert
    pygame.draw.rect(ecran, COULEURS["BRUN"],
    ...
    for colonne in range(10):
        for ligne in range(10):
            ...
            couleur_case = COULEURS["NOIR"] if (colonne + ligne) % 2 == 1 else COULEURS["BLANC"]
